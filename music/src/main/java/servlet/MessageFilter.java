...
public class MessageFilter implements Filter{
	@NotNull
	private List<String> listLllegals = new Vector<String>();
	
	public void destroy() {
		
	}

	public void doFilter(ServletRequest arg0, ServletResponse arg1, @NotNull FilterChain arg2)
	...
	public void init(@NotNull FilterConfig arg0) throws ServletException {
